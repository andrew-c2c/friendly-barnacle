...
schedule.every().day.at('13:42').do(email_send,'It is 13:42') #https://stackoverflow.com/questions/15088037/python-script-to-do-something-at-the-same-time-every-day - https://pypi.org/project/schedule/
